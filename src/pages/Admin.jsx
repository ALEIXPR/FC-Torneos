...
import { Trash2, Users, Play, Trophy, ChevronDown, Plus, ChevronLeft, Settings } from 'lucide-react';
  ...
  if (!isAuthenticated) {
    return (
      <div className="container flex-center" style={{ minHeight: '60vh' }}>
        ...
        >
          <h2 className="heading-md text-center" style={{ marginBottom: '1.5rem', color: 'var(--accent-primary)' }}>Panel de Control (Admin)</h2>
          <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            />
            <button type="submit" className="btn-primary">Acceder al Backend</button>
          </form>
        </motion.div>
      </div>
    );
      ...
      {tournamentState === 'setup' && (
        <div className="card-glass" style={{ marginBottom: '2rem' }}>
          ...
          <form onSubmit={handleAddPlayer} style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
            ...
            {/* Estadísticas falsas eliminadas. Foco E-Sports Real. */}
